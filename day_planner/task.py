...
class Task:
    def __init__(self, pe: int, total_hours: float, location: str = None, fixed_times: List[List[TypeVar]] = None, mode=None):
        ...
        self.fixed_times = fixed_times # List[List[day: str, start_time: int, end_time:int, mode:str]] where day is day of the week task needs 
                                       # to be completed and start and end times are times task needs to be comlplted (military time int),
        self.mode = mode # mode is mode of transportation one of walking, transit, driving, bicycling
